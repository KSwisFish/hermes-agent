...
// checkout under $HERMES_HOME/lumina-agent. Used as a last-resort fallback when
...
function installedAgentInstallScript(hermesHome) {
  ...
  const candidate = path.join(hermesHome, 'lumina-agent', 'scripts', installScriptName())
